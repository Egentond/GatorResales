      ...
      <div className="relative h-screen min-h-screen bg-cover bg-center" style={{ backgroundImage: `url(${gatorCountry})` }}>
        ...
        <div className="align-middle content-center justify-center">
            ...
            <div className='align-middle text-center relative flex gap-8 mt-40 content-center justify-center'>
              ...
              <div className="bg-white bg-opacity-80 p-4 rounded shadow-md w-80 transition ease-in-out delay-150 text-gatorsBlue hover:bg-gatorsBlue hover:scale-110 hover:text-white">
                <p className='text-xl'>Football</p>
                <img src={gatorsFootball} alt="Gators Football"/>
              </div>
              
              <div className="bg-white bg-opacity-80 p-4 rounded shadow-md w-80 transition ease-in-out delay-75 text-gatorsBlue hover:bg-gatorsBlue hover:scale-110 hover:text-white">
